...
import io.noties.markwon.image.gif.GifSupport.missingMessage
import pl.droidsonroids.gif.GifDrawable
import java.io.ByteArrayOutputStream
import java.io.IOException
import java.io.InputStream

open class GifMediaDecoder protected constructor(
    private val autoPlayGif: Boolean
) : MediaDecoder() {
    init {
        validate()
    }
    ...
    companion object {
        ...
        private fun validate() {
            check(hasGifSupport()) { missingMessage() }
        }
    }
}
