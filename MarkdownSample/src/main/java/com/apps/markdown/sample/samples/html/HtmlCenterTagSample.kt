...
import com.apps.markdown.sample.samples.html.shared.IFrameHtmlPlugin
...
class HtmlCenterTagSample : MarkwonTextViewSample() {
    override fun render() {
        val html = "<html>\n" +
                "\n" +
                "<head></head>\n" +
        ...
        val markwon: Markwon = Markwon.builder(context)
            .usePlugin(HtmlPlugin.create(object : HtmlConfigure {
                override fun configureHtml(plugin: HtmlPlugin) {
                    plugin.addHandler(CenterTagHandler())
                }
            }))
...
internal class CenterTagHandler : io.noties.markwon.html.TagHandler() {
    override fun handle(
