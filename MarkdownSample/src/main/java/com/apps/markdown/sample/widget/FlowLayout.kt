...
class FlowLayout(context: Context, attrs: AttributeSet) : ViewGroup(context, attrs) {
    ...
    init {
        ...
        try {
            ...
            spacingVertical =
                array.getDimensionPixelSize(R.styleable.FlowLayout_fl_spacingVertical, spacing)
            spacingHorizontal =
                array.getDimensionPixelSize(R.styleable.FlowLayout_fl_spacingHorizontal, spacing)
        } finally {
            array.recycle()
        }
    }
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        for (i in 0 until childCount) {
            ...
            child.layout(
                left, top, left + child.measuredWidth, top + child.measuredHeight
            )
        }
    }
