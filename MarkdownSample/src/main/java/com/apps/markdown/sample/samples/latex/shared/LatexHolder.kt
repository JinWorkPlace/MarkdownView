package com.apps.markdown.sample.samples.latex.shared

object LatexHolder {
    var LATEX_ARRAY: String? = null
    const val LATEX_LONG_DIVISION: String = "\\text{A long division \\longdiv{12345}{13}"
    const val LATEX_BANGLE: String = "{a \\bangle b} {c \\brace d} {e \\brack f} {g \\choose h}"
    var LATEX_BOXES: String? = null
